...
spellbooks]({{ site.baseurl }}{% link guide/1.3.6-equipment.md %}) that are rewarded from quests.
...
10. [Evolve]({{ site.baseurl }}{% link guide/1.3.5-bloom.md %})
11. [Limit Break]({{ site.baseurl }}{% link guide/1.3.4-stars.md %})
